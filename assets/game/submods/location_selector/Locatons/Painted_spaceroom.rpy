...
init -990 python:
    store.mas_submod_utils.Submod(
        author="Toffee",
        name="Red Painted Spaceroom",
        description="This submod adds a red painted wall spaceroom for you and Monika.",
        version="1.0.0"
    )
...
init -989 python:
    if store.mas_submod_utils.isSubmodInstalled("Submod Updater Plugin"):
        store.sup_utils.SubmodUpdater(
            submod="Red Painted Spaceroom",
            user_name="toffeezx",
            repository_name="Painted-Spaceroom-Red-Paint",
            update_dir="",
            attachment_id=None
        )

###START: IMAGE DEFINITIONS
image submod_background_Painted_spaceroom_day = "mod_assets/location/P Spaceroom Red/p-spaceroom.png"
image submod_background_Painted_spaceroom_rain = "mod_assets/location/P Spaceroom Red/p-spaceroom_rain.png"
image submod_background_Painted_spaceroom_overcast = "mod_assets/location/P Spaceroom Red/p-spaceroom_overcast.png"
image submod_background_Painted_spaceroom_snow = "mod_assets/location/P Spaceroom Redp-spaceroom_snow.png"

#Night images
image submod_background_Painted_spaceroom_night = "mod_assets/location/P Spaceroom Red/p-spaceroom-n.png"
image submod_background_Painted_spaceroom_rain_night = "mod_assets/location/P Spaceroom Red/p-spaceroom_rain-n.png"
image submod_background_Painted_spaceroom_overcast_night = "mod_assets/location/P Spaceroom Red/p-spaceroom_overcast-n.png"
image submod_background_Painted_spaceroom_snow_night = "mod_assets/location/P Spaceroom Red/p-spaceroom_snow-n.png"

#Sunset images
image submod_background_Painted_spaceroom_ss = "mod_assets/location/P Spaceroom Red/p-spaceroom-ss.png"
image submod_background_Painted_spaceroom_rain_ss = "mod_assets/location/P Spaceroom Red/p-spaceroom_rain-ss.png"
image submod_background_Painted_spaceroom_overcast_ss = "mod_assets/location/P Spaceroom Red/p-spaceroom_overcast-ss.png"
image submod_background_Painted_spaceroom_snow_ss = "mod_assets/location/P Spaceroom Red/p-spaceroom_snow-ss.png"

image P_d25_deco = ConditionSwitch(
    "mas_current_background.isFltDay()", "mod_assets/location/P Spaceroom Red/deco/d25/deco.png",
    "True", "mod_assets/location/P Spaceroom Red/deco/d25/deco-n.png"
)
...
image Pmas_d25_gifts = ConditionSwitch(
    "len(persistent._mas_d25_gifts_given) == 0", "mod_assets/location/P Spaceroom Red/deco/d25/Pgifts_0.png",
    "0 < len(persistent._mas_d25_gifts_given) < 3", "Pmas_d25_gifts_1",
    "3 <= len(persistent._mas_d25_gifts_given) <= 4", "Pmas_d25_gifts_2",
    "True", "Pmas_d25_gifts_3"
)

image Pmas_d25_gifts_1 = MASFilterSwitch(
    "mod_assets/location/P Spaceroom Red/deco/d25/Pgifts_1.png"
)

image Pmas_d25_gifts_2 = MASFilterSwitch(
    "mod_assets/location/P Spaceroom Red/deco/d25/Pgifts_2.png"
)

image Pmas_d25_gifts_3 = MASFilterSwitch(
    "mod_assets/location/P Spaceroom Red/deco/d25/Pgifts_3.png"
)




image Pmas_d25_tree = ConditionSwitch(
    "mas_isNightNow()", ConditionSwitch(
        "persistent._mas_disable_animations", "mod_assets/location/P Spaceroom Red/deco/d25/Ptree_lights_on_1.png",
        "not persistent._mas_disable_animations", "Pmas_d25_night_tree_lights_atl"
    ),
    "True", MASFilterSwitch(
        "mod_assets/location/P Spaceroom Red/deco/d25/Ptree_lights_off.png"
    )
)

image Pmas_d25_night_tree_lights_atl:
    block:
        "mod_assets/location/P Spaceroom Red/deco/d25/Ptree_lights_on_1.png"
        1.5
        "mod_assets/location/P Spaceroom Red/deco/d25/Ptree_lights_on_2.png"
        1.5
        "mod_assets/location/P Spaceroom Red/deco/d25/Ptree_lights_on_3.png"
        1.5
    repeat
...
image Pmas_d25_lights = ConditionSwitch(
    "mas_isNightNow()", ConditionSwitch(
        "persistent._mas_disable_animations", "mod_assets/P Spaceroom Red/deco/d25/Plights_on_1.png",
        "not persistent._mas_disable_animations", "Pmas_d25_night_lights_atl"
    ),
    "True", MASFilterSwitch("mod_assets/location/P Spaceroom Red/deco/d25/Plights_off.png")
)

image Pmas_d25_night_lights_atl:
    block:
        "mod_assets/location/P Spaceroom Red/deco/d25/Plights_on_1.png"
        0.5
        "mod_assets/location/P Spaceroom Red/deco/d25/Plights_on_2.png"
        0.5
        "mod_assets/location/P Spaceroom Red/deco/d25/Plights_on_3.png"
        0.5
    repeat
...
init 501 python:
    MASImageTagDecoDefinition.register_img(
        ...
        submod_background_Painted_spaceroom.background_id,
    ...
    MASImageTagDecoDefinition.register_img(
        ...
        submod_background_Painted_spaceroom.background_id,
        MASAdvancedDecoFrame(zorder=4),
        replace_tag="P_d25_deco"
    )

init -1 python:
    submod_background_Painted_spaceroom = MASFilterableBackground(
        # ID
        "submod_background_Painted_spaceroom",
        "Painted Spaceroom (Red Paint)",

        # mapping of filters to MASWeatherMaps
        MASFilterWeatherMap(
            day=MASWeatherMap({
                store.mas_weather.PRECIP_TYPE_DEF: "submod_background_Painted_spaceroom_day",
                store.mas_weather.PRECIP_TYPE_RAIN: "submod_background_Painted_spaceroom_rain",
                store.mas_weather.PRECIP_TYPE_OVERCAST: "submod_background_Painted_spaceroom_overcast",
                store.mas_weather.PRECIP_TYPE_SNOW: "submod_background_Painted_spaceroom_snow",
            }),
            night=MASWeatherMap({
                store.mas_weather.PRECIP_TYPE_DEF: "submod_background_Painted_spaceroom_night",
                store.mas_weather.PRECIP_TYPE_RAIN: "submod_background_Painted_spaceroom_rain_night",
                store.mas_weather.PRECIP_TYPE_OVERCAST: "submod_background_Painted_spaceroom_overcast_night",
                store.mas_weather.PRECIP_TYPE_SNOW: "submod_background_Painted_spaceroom_snow_night",
            }),
            sunset=MASWeatherMap({
                store.mas_weather.PRECIP_TYPE_DEF: "submod_background_Painted_spaceroom_ss",
                store.mas_weather.PRECIP_TYPE_RAIN: "submod_background_Painted_spaceroom_rain_ss",
                store.mas_weather.PRECIP_TYPE_OVERCAST: "submod_background_Painted_spaceroom_overcast_ss",
                store.mas_weather.PRECIP_TYPE_SNOW: "submod_background_Painted_spaceroom_snow_ss",
            }),
        ),
        ...
        hide_calendar=False,
        unlocked=True,
        entry_pp=store.mas_background._Painted_spaceroom_entry,
        exit_pp=store.mas_background._Painted_spaceroom_exit,
        ex_props={"skip_outro": None}
    )


init -2 python in mas_background:
    def _Painted_spaceroom_entry(_old, **kwargs):
        """
        Entry programming point for Painted_spaceroom background
        """
        if kwargs.get("startup"):
            pass

        else:
            if not store.mas_inEVL("Painted_spaceroom_switch_dlg"):
                store.pushEvent("Painted_spaceroom_switch_dlg")

        if store.seen_event("mas_monika_islands"):
            store.mas_unlockEVL("mas_monika_islands", "EVE")

    def _Painted_spaceroom_exit(_new, **kwargs):
        """
        Exit programming point for Painted_spaceroom background
        """
...
###START: Topics
label Painted_spaceroom_switch_dlg:
    python:
        switch_quip = renpy.substitute(renpy.random.choice([
            "I wonder what you're favorite color is...",
            "The classic look with a little change.",
            "The paint color looks so pretty!",
        ]))
